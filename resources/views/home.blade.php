             ...
             <div class="panel-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title">Solicitudes asignadas a mí</h3>
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title">Solicitudes sin asignar</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            <thead>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title">Solicitudes reportadas por mí</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-bordered">
                            <thead>
